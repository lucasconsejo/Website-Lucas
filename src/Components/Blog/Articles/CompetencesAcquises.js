...
class CompetencesAcquises extends Component{
        ...
        return(
            <div>
                ...
                <div id="container-blog-cdiscount">
                    <div id="img-fond-competences-acquises">
                        
                    </div>
                
                    <div className="container">
                        <div id="blog-intro">
                            <p className="previous-page"><Link to="/blog" className="previous-page">Accueil</Link> > <Link to="/blog/stage/cdiscount" className="previous-page">Stage Cdiscount</Link> > <Link to="/blog/stage/cdiscount/article/competences-acquises" className="previous-page">Article Compétences acquises</Link></p>
...
export default CompetencesAcquises